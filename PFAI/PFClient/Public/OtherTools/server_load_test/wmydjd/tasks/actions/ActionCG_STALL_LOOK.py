...
class ActionCG_STALL_LOOK:
    def __init__(self, person):
        self.person = person

    def run(self):
        packet = net_packets.PACKETS.CG_STALL_LOOK(self.person)
        ...
        packet['reserved2'] = self.person['reserved2']
        ...
        # Functions.wait_for_packet(self.person, "CG_STALL_LOOK")
        return res
