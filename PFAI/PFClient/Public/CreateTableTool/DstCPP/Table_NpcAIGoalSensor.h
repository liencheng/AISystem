...
private:
 int32_t m_CalGoalInterval;
 public:
 int32_t GetCalGoalInterval() const { return m_CalGoalInterval; }
...
private:
 int32_t m_GoalTimeOut;
 public:
 int32_t GetGoalTimeOut() const { return m_GoalTimeOut; }
