...
namespace Unity.Collections
{
        ...
        where TValue : unmanaged
    {
        ...
        /// <param name="isUnOrdered">forearch hashmap by hash ordered</param>
        public NativeHashMap(int initialCapacity, AllocatorManager.AllocatorHandle allocator,bool isUnOrdered = false)
        {
            m_IsUnOrdered = isUnOrdered;
        ...
        public Enumerator GetEnumerator()
        {
            ...
            return new Enumerator
            {
                ...
                m_Safety = ash,
#endif
                m_Enumerator = new HashMapHelper<TKey>.Enumerator(m_Data,m_IsUnOrdered),
            };
        }
